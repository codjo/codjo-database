...
public abstract class AbstractDatabaseHelperTestOld {
    ...
    public void test_createConnection() throws Exception {
        ...
        junit.framework.Assert.assertEquals(buildDatabaseUrl(properties), connection.getMetaData().getURL());
    }
    ...
    public void test_dropForeignKey_noFK() throws Exception {
        ...
        databaseHelper.dropForeignKey(jdbcFixture.getConnection(), foreignKey("FK_UNKNOWN", table));
    }
    ...
    public void test_buildTablesOrder() throws Exception {
        ...
        junit.framework.Assert.assertEquals("JDBC_TEST_1", tablesOrder.get(0).toUpperCase());
        junit.framework.Assert.assertEquals("JDBC_TEST_2", tablesOrder.get(1).toUpperCase());
        junit.framework.Assert.assertEquals("JDBC_TEST_3", tablesOrder.get(2).toUpperCase());
    }


    protected abstract void assertCustomConnectionUrl(String actualUrl) throws Exception;


    protected abstract void assertDefaultConnectionUrl(String actualUrl) throws Exception;
    ...
    public void test_createApplicationConnectionMetadata() throws Exception {
        ...
        try {
            assertTrue(databasePropertiesFile.exists());
            ...
            assertTrue(databasePropertiesFile.delete());
        }
    }
